function [pos_ans, q] = SAM_Detection_20Hz_MLP(std_level, var_level, nAFC)

% Sinusoidal Amplitude Modulation (SAM) noise discrimination. A 500-ms
% Gaussian noise is sinusoidally amplitude modulated at 20-Hz. The depth
