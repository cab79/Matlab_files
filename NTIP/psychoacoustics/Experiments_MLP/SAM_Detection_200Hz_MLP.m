function [pos_ans, q] = SAM_Detection_200Hz_MLP(std_level, var_level, nAFC)

% Sinusoidal Amplitude Modulation (SAM) noise discrimination. A 500-ms
% Gaussian noise is sinusoidally amplitude modulated at 200-Hz. The depth
