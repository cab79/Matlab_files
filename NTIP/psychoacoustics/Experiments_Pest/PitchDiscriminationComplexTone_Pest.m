function [pos_ans, q] = PitchDiscriminationComplexTone_Pest(std_level, var_level, nAFC)
...
% - STANDARD LEVEL: the frequency of standard tone.
...
% [1] %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% GENERATE SOUNDS
variable = GenerateTone(sf, dur, [(var_level)*1, (var_level)*2, (var_level)*3, (var_level)*4]);
