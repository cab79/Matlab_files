function [pos_ans, q] = GapDiscriminationWhiteNoise_Pest(std_level, var_level, nAFC)

% Gap-duration discrimination. The standard is a 750-ms Gaussian noise with
% a silence of standard duration placed at its temporal center. The variable
...
% at onset and offset.
% - PARAMETER VARIED ADAPTIVELY: the duration of the variable gap;
% - STANDARD LEVEL: the duration of the standard gap.
