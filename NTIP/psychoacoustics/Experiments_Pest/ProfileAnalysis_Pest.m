function [pos_ans, q] = ProfileAnalysis_Pest(std_level, var_level, nAFC)
...
% given in dB.
% - PARAMETER VARIED ADAPTIVELY: the level of the 3rd component;
% - STANDARD LEVEL: the level of the remaining components.
