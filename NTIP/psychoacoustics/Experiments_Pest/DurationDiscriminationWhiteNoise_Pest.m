function [pos_ans, q] = DurationDiscriminationWhiteNoise_Pest(std_level, var_level, nAFC)
...
% 10-ms.
% - PARAMETER VARIED ADAPTIVELY: the duration of the variable noise;
% - STANDARD LEVEL: the duration of the standard noise.
...
% [1] %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% GENERATE SOUNDS
variable = GenerateNoise(sf, var_level);
