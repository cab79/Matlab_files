function [pos_ans, q] = DurationDiscriminationComplexTone_S(std_level, var_level, nAFC)
...
% between variable and standard tone;
...
% [1] %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% GENERATE SOUNDS
variable = GenerateTone(sf, std_level+var_level, freqs);
