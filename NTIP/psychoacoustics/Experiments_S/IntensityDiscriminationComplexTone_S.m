function [pos_ans, q] = IntensityDiscriminationComplexTone_S(std_level, var_level, nAFC)
...
% cosine ramps.
% - PARAMETER VARIED ADAPTIVELY: the delta, i.e., the difference in level
% between standard and variable tone;
% - STANDARD LEVEL: here it corresponds to the level of the standard tone.
...
variable = AttenuateSound(variable, std_level+var_level);
