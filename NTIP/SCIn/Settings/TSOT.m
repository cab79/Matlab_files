...
switch opt
    ...
    case '1'
        ...
        %h.Settings.stimtypeouts_init = [2 3; 1 3; 5 6; 4 6];
        %if opt.onehand
        %    h.Settings.stimtypeouts_init = [2 3; 1 4];
        %    %number of hands being stimulated
        %    h.Settings.num_hands = 1;
        %else
            h.Settings.stimtypeouts_init = [2 3; 1 4; 6 7; 5 8];
            %number of hands being stimulated
...
h.Settings.startmessage = 'Put electrodes on participant and press OK to continue.';
...
%if h.Settings.num_changes*h.Settings.num_hands~=length(h.Settings.stimtypeouts_init)
