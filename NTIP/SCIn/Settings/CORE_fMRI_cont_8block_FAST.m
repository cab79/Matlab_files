...
switch opt
    ...
    case 'fMRI_run'
        ...
        %number of blocks of each change probability (CP)
        h.Settings.cond_rep_init = [4 4]; % this DIVIDES nchanges_per_cond, i.e. does not increase the number of changes
        %number of stimulus location changes within each CP condition
...
h.Settings.conditionvalue = [23 23 200 500; 1 1 1 1];% for each number in h.Settings.stimtypeouts_init,
