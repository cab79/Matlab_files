...
for f = 1:length(S.filelist)
    ...
    switch S.analysistype
        ...
        case {'Freq','TF','Coh'}
            ...
            % freq analysis
            fdata = FTfreqanalysis(FTEEG,S.analysistype,S.freqsrange,intimes,S.basewin,S.ncycles);
            ...
            if strcmp(S.analysistype,'Coh')
                ...
                for nboot = 1:S.bootrep
                    ...
                    fdata = FTfreqanalysis(fdata,S.analysistype,S.freqsrange,intimes,S.basewin,S.ncycles);
