...
origpath = 'Y:\Marie Shorrock\Kathy LED\Practice\S01-S32_VC sets'; % unprocessed data
anapath = 'Y:\Marie Shorrock\Kathy LED\Practice\S01-S32_VC preprocessed'; % folder to save analysed data
design_path = 'Y:\Marie Shorrock\Kathy LED\Practice\S01-S32_VC Raw'; % contains some related information about the study design

% FIND THE DATA FILES
cd(origpath);
files = dir('S*_VC_orig.set');
...
notch_on = 3;
addpath(genpath('Y:\Marie Shorrock\Kathy LED\Practice\S01-S32_VC Supporting Data'));
