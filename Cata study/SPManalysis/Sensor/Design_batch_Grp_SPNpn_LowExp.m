...
D.batch_path = 'C:\Data\Matlab\Matlab_files\Cata study\SPManalysis\Sensor\Design_batch_Grp_SPNpn_LowExp.m';
...
D.factors = {'Grp', 'Att', 'Subject'}; % must include a subject factor at the end; Group factor must be first if being used
