...
S.timewin = [-3000 0;-3000 0]; % Best to narrow this as much as possible to the range of interest. Empty will include whole epoch. 
S.basewin = [-3000 -2500;-3000 -2500]; % empty will not baseline correct and will not produce a baseline image.
