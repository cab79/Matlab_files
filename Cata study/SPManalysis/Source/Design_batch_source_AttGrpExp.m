...
D.batch_path = 'C:\Data\Matlab\Matlab_files\Cata study\SPManalysis\Source\Design_batch_source_AttGrpExp.m';
...
identifier={'_t-4690_-4672'};
D.baseline='_t-5500_-5000'; 
%identifier={'_t336_356'};
%D.baseline='_t-500_0'; 
...
for di = 1:length(identifier)
    ...
    D.fcontrasts = {
        ...
        [-1 1 1 -1 0 0 0 0], 'Att1 Grp * Exp'
        [0 0 0 0 -1 1 1 -1], 'Att2 Grp * Exp'
        [1 1 1 1 -1 -1 -1 -1], 'Att'
        [1 1 -1 -1 0 0 0 0], 'Att1 Grp'
        [-1 1 -1 1 0 0 0 0], 'Att1 Exp'
        [0 0 0 0 1 1 -1 -1], 'Att2 Grp'
        [0 0 0 0 -1 1 -1 1], 'Att2 Exp'
        };
    ...
    D.tcontrasts = {
        ...
        [1 1 0 0 -1 -1 0 0], 'G1 Att A'
        [0 0 1 1 0 0 -1 -1], 'G2 Att A'
        [-1 -1 0 0 1 1 0 0], 'G1 Att B'
        [0 0 -1 -1 0 0 1 1], 'G2 Att B'
