...
S.outpath = 'C:\Data\Catastrophising study\SPMdata\sourceimages_LEP'; 
...
%S.timewin = [-3000 -1000]; % Best to narrow this as much as possible to the range of interest. Empty will include whole epoch. 
...
%S.basewin = [-3000 -2500]; % empty will not baseline correct and will not produce a baseline image.
S.timewin = [0 1000]; % empty will include whole epoch. Best to narrow this as much as possible to the range of interest.
