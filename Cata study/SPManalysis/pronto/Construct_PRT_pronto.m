...
D.identifier='_Exp_earlycue2_gpc_ROI'; % optional identifer to add to end of outputted SPM folder name
...
D.time_ana = [-2200 -1800]; % applies a temporal mask to the data (first level)
