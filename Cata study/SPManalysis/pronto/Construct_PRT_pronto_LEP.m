...
D.identifier='_gpc_ROI'; % optional identifer to add to end of outputted SPM folder name
...
D.time_ana = [-5500 1500]; % applies a temporal mask to the data (first level)
