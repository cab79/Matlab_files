...
D.identifier='_GrpHighExp_gpc_ROI_perm1000weights_no2'; % optional identifer to add to end of outputted SPM folder name
...
D.maineffects = [1 0 0]; % one column per factor 
...
% are needed by specifying 'contrast' here. Alternatively, 
D.fileoptype = 'meancond'; % contrast or meancond
...
% permutation testing
D.permtest = 1000;
D.saveallweights = 1; % Requires added code to prt_compute_weights_class.m, line 287:
...
% 2. Sample averaging (within subject and condition): constructs samples by computing the average of
