function c = bayes_optimal_binary_CAB_config(r,S)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%
% Usage:
%     tapas_fitModel([], inputs, '<perceptual_model>', 'tapas_bayes_optimal_binary_config', ...)
% 
...
% Model filehandle
c.obs_fun = @bayes_optimal_binary_CAB;

% This is the handle to a dummy function since there are no parameters to transform
c.transp_obs_fun = @bayes_optimal_binary_CAB_transp;
