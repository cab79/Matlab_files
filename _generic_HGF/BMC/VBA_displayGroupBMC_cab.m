function handles = VBA_displayGroupBMC(posterior,out,pep_flag)
% CAB: added option to display PEP
...
cla(handles.ha(4))
if pep_flag
    bar(handles.ha(4),out.pep,'facecolor',0.8*[1 1 1])
else
...
if pep_flag
    VBA_title(handles.ha(4),'protected exceedance probabilities')
else
