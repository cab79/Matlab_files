function [posterior,out] = VBA_groupBMC(L,options,pep_flag)
...
if options.DisplayWin
    ...
    options.handles = VBA_displayGroupBMC_cab(posterior,out,pep_flag);
    drawnow
end
...
try
    ...
    if ~isempty(out.options.families)
        ...
        out.families.pep = (1-out.bor)*out.families.ep + out.bor/length(out.families.ep);
    end
catch
    if options.verbose
...
if options.DisplayWin
    VBA_displayGroupBMC_cab(posterior,out,pep_flag);
end
