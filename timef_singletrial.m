...
function [P,PS,R,mbase,times,freqs,Pboot,Rboot,Rphase,PA] = timef_singletrial(X,frames,tlimits,Fs,varwin,varargin);
...
if (g.cycles == 0) %%%%%%%%%%%%%% constant window-length FFTs %%%%%%%%%%%%%%%%
    ...
    PS  = zeros(g.padratio*g.winsize/2,g.timesout,trials); % single-trial summed power
