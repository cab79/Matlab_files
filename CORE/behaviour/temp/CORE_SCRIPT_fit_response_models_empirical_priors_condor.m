...
function CORE_SCRIPT_fit_response_models_empirical_priors_condor(filebase,grp,it_in)
...
S.expt = 'part2'; %
S.path.seq = ['/home/cab79/Data']; % unprocessed data in original format
S.path.raw = ['/home/cab79/Data']; % unprocessed data in original format
S.path.prep = ['/home/cab79/Data']; % folder to save processed data
S.path.hgf = ['/home/cab79/Data']; % folder to save processed data
S.path.design = ['/home/cab79/Data']; % 
...
S.path.datfile = ['/home/cab79/Data/Participant_data.xlsx']; % .xlsx file to group participants; contains columns named 'Subject', 'Group', and any covariates of interest
%save(fullfile(S.path.prep,'S'),'S'); % saves 'S' - will be overwritten each time the script is run, so is just a temporary variable

% add toolbox paths
addpath(genpath('/home/cab79/Matlab'))
addpath(genpath('/home/cab79/Data'))
