...
cp $pth/dependencies/Matlab_files/CORE/behaviour/CORE_condor_fit_step1.m $pth
cp $pth/dependencies/Matlab_files/CORE/behaviour/CORE_condor_fit_step2.m $pth
