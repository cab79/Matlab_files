...
## MUST be run by specifying a grp number, e.g. "sh filename.sh 1"
...
cp $pth/dependencies/Matlab_files/CORE/condor/CORE_HGF_rand/CORE_condor_fit_step1.m $pth
cp $pth/dependencies/Matlab_files/CORE/condor/CORE_HGF_rand/CORE_condor_fit_step2.m $pth
