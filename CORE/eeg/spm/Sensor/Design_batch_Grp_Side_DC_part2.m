...
D.batch_path = 'C:\Data\Matlab\Matlab_files\CORE\EEG\spm\Sensor\Design_batch_Grp_Side_DC_part2.m';
...
D.factors = {'Side', 'Grp', 'DC', 'Subject'}; % must include a subject factor at the end
