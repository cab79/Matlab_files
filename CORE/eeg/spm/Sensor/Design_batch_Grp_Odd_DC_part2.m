...
D.batch_path = 'C:\Data\Matlab\Matlab_files\CORE\EEG\spm\Sensor\Design_batch_Grp_Odd_DC_part2.m';
...
D.factors = {'Odd', 'Grp', 'DC', 'Subject'}; % must include a subject factor at the end
...
D.fcontrasts = {
    ...
    [1 1 -1 -1 1 1 -1 -1], 'Grp'
    [1 -1 1 -1 1 -1 1 -1], 'DC'
    [1 1 -1 -1 -1 -1 1 1], 'Odd*Grp'
    [1 -1 -1 1 1 -1 -1 1], 'Grp*DC'
    [1 -1 1 -1 -1 1 -1 1], 'Odd*DC'
    [1 -1 -1 1 -1 1 1 -1], 'Odd*Grp*DC'
