...
D.batch_path = 'C:\Data\Matlab\Matlab_files\CORE\EEG\spm\Sensor\Design_batch_NoGrp_part2.m';
...
D.factors = {'Side', 'Odd', 'DC', 'Subject'}; % must include a subject factor at the end
...
D.fcontrasts = {
    ...
    [1 -1 1 -1 -1 1 -1 1], 'Side * DC'
    [1 -1 -1 1 1 -1 -1 1], 'Odd * DC'
    [1 -1 -1 1 -1 1 1 -1], 'Side * Odd * DC'
    [1 1 0 0 -1 -1 0 0], 'Odd: Side'
    [1 -1 0 0 1 -1 0 0], 'Odd: DC'
    [1 -1 0 0 -1 1 0 0], 'Odd: Side * DC'
    };
D.tcontrasts = {
