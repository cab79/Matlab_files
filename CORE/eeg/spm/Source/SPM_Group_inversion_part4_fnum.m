...
S.outpath = 'C:\Data\CORE\EEG\ana\spm\SPMdata\sourceimages_COH_flip_prior'; 
...
S.freqwin = [0 100]; % high pass and low pass filter
S.timewin = [30 50;70 120;160 240]; % empty will include whole epoch. Best to narrow this as much as possible to the range of interest.%
S.cond = {{'1'},{'2'},{'3'},{'4'},{'5'},{'6'},{'7'},{'8'}};
%S.cond = {{'8'}};
...
S.group_inversion = 1;
S.sourceprior = 'COH'; % Priors on sources, e.g. MSP, GS, COH or IID
