...
P.filenames = {'farate_aff_long_GrpBySide.xlsx'}; % use * to load multiple files, each with separate plots. Filename must have extension
% name of data column
P.datnames = {'Data'};
% y axis label (should correspond to data type)
P.yaxisnames = {'False Alarm Rate (%)'};
%factor names:
