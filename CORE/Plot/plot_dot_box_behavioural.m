...
P.filenames = {'GOT_short_long_20170823T113826.xlsx'}; % use * to load multiple files, each with separate plots. Filename must have extension
% name of data column
P.datnames = {'Data'};
% y axis label (should correspond to data type)
P.yaxisnames = {'Threshold (mm)'};
%factor names:
