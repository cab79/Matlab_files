...
% 
% S.spm_path = 'C:\Data\CORE\eeg\ana\spm\SPMstats\sensor\t-200_899_b-200_0_m_0_800_CP_Odd_DC_Subject_2_merged_cleaned_stats_BRR_all_chan_condHGF_notrans_20190221T154622_pred1_spm';
% col = cbrewer('seq', 'YlOrBr', 100, 'pchip'); %orange
% St.eeglab_path = 'C:\Data\CORE\EEG\ana\sim';
% 
% S.spm_path = 'C:\Data\CORE\eeg\ana\spm\SPMstats\sensor\t-200_899_b-200_0_m_0_800_CP_Odd_DC_Subject_2_merged_cleaned_stats_BRR_all_chan_condHGF_notrans_20190221T154622_pred2_spm';
% col = cbrewer('seq', 'Purples', 100, 'pchip'); 
% St.eeglab_path = 'C:\Data\CORE\EEG\ana\sim';
% 
% S.spm_path = 'C:\Data\CORE\eeg\ana\spm\SPMstats\sensor\t-200_899_b-200_0_m_0_800_CP_Odd_DC_Subject_2_merged_cleaned_stats_BRR_all_chan_condHGF_notrans_20190221T154622_pred3_spm';
% col = cbrewer('seq', 'Blues', 100, 'pchip'); 
% St.eeglab_path = 'C:\Data\CORE\EEG\ana\sim';

S.spm_path = 'C:\Data\CORE\eeg\ana\spm\SPMstats\sensor\t-200_899_b-200_0_m_0_800_CP_Odd_DC_Subject_2_merged_cleaned_stats_BRR_all_chan_condHGF_notrans_20190221T154622_pred4_spm';
...
for p = 1:length(D)
    ...
    P(p).colours = col_erp; % red, black; [0.5 0 0.5; 1 0.5 0; 0 0.5 0]; % purple, orange, green 
