...
%S.facplot={'Exp'};
% clusters to plot
S.plotclus = {'c5_spm','c1_spm','c2_spm','c3_spm','c4_spm'};
...
St.en_string='\scond';
St.ERPsavename = 'ERP_DAT_Sideavg.mat';
St.plot_diff_wave = 1;
St.use_flipped=1;
...
for p = 1:length(D)
    ...
    P(p).colours = [1 0.5 0; 0.5 0 0.5]; % purple, orange, green 
...
adjustment = 1.00; % need to play with this to get it the same as other figures
