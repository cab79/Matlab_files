...
S.import.select.subjects = {'MNP_001'}; % either single/multiple subjects, or leave blank to process all subjects in the datfile
...
S.prep.select.subjects = {'MNP_001'}; % either single/multiple subjects, or leave blank to process all subjects in the datfile
...
S.prep2.select.subjects = {'MNP_001'}; % either a single subject, or leave blank to process all subjects in folder
...
S.tf.select.subjects = {'MNP_001'}; % either single/multiple subjects, or leave blank to process all subjects in the datfile
...
S.ploterp.select.subjects = {'MNP_001'}; % either a single subject, or leave blank to process all subjects in folder
