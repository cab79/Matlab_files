function c = tapas_hgf_binary_pu_CORE_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Alpha
% Format: scalar.
c.logalmu = repmat(log(0.5),1,c.n_inputs);
c.logalsa = repmat(1,1,c.n_inputs);

% Eta0
% Format: scalar.
c.eta0mu = repmat(0,1,c.n_inputs);
c.eta0sa = repmat(0,1,c.n_inputs);

% Eta1
% Format: scalar.
c.eta1mu = repmat(1,1,c.n_inputs);
c.eta1sa = repmat(0,1,c.n_inputs);
...
expectedLength = 4*c.n_levels+1*(c.n_levels-1)+c.n_inputs*3;
...
c.prc_fun = @tapas_hgf_binary_pu_CORE;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @tapas_hgf_binary_pu_CORE_transp;
