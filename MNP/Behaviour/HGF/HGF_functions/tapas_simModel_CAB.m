function r = tapas_simModel_CAB(inputs, prc_model, prc_pvec, varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
r.p_prc   = prc_namep_fun(prc_pvec,prc_config_fun);
r.p_prc.p = prc_pvec;
...
%CAB
if nargin > 6
    obs_config_fun = varargin{4};
else
    try
        obs_config_fun = [obs_model, '_config'];
    end
end
...
if nargin > 4
    if ~isempty(varargin{1}) % CAB
        ...
        try
            obs_config_fun = str2func(obs_config_fun);
