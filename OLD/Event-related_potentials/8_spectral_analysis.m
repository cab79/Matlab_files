...
all_spect = zeros(62,length(subjects),length(sessions),3);
delta = zeros(62,length(subjects),length(sessions),3);
theta = zeros(62,length(subjects),length(sessions),3);
alpha = zeros(62,length(subjects),length(sessions),3);
beta = zeros(62,length(subjects),length(sessions),3);
gamma1 = zeros(62,length(subjects),length(sessions),3);
gamma2 = zeros(62,length(subjects),length(sessions),3);
...
frames = 1501; %frames per epoch {0 -> data length}
