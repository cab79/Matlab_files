...
S.acc_tw = 'daily'; % current options: 'daily'. Other options: a number of hours, e.g. '2' (not yet programmed)
% time window to apply to pain ratings data
S.pr_tw = 'daily'; % current options: 'daily'. Other options: a number of hours, e.g. '2' (not yet programmed)
