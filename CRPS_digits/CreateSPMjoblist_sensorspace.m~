...
if isunix
    filepath = '/scratch/cb802/Data/CRPS_Digit_Perception_exp1/correcttrials/SPM image files/Sensorspace_images';
    run('/scratch/cb802/Matlab_files/CRPS_digits/loadsubj.m');
else
    filepath = 'W:\Data\CRPS_Digit_Perception_exp1\correcttrials\SPM image files\Sensorspace_images';
