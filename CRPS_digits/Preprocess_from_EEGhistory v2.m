...
for f = 1:length(files)
    ...
    EEGn1 = pop_epoch( EEGn1, {'STIM'}, [-0.1 0.1], 'newname', [C{1} '_epochs1'], 'epochinfo', 'yes');
    EEGn2 = pop_epoch( EEGn2, {'STIM'}, [-0.1 0.1], 'newname', [C{1} '_epochs2'], 'epochinfo', 'yes');
   ...
   EEG = pop_runica(EEG, 'extended',1,'interupt','on','pca',correctRank);
   sname = [C{1} '_ICA.set'];
